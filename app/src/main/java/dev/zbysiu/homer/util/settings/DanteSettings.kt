package dev.zbysiu.homer.util.settings

import android.content.Context
import android.content.SharedPreferences
import dev.zbysiu.homer.R
import dev.zbysiu.homer.util.scheduler.SchedulerFacade
import dev.zbysiu.homer.util.settings.delegate.boolDelegate
import dev.zbysiu.homer.util.settings.delegate.stringDelegate
